...
omitting it) is **byte-identical** to the plain `docex test` above. The slot is a
general compiler primitive (any fixed env can be instantiated into multiple isolated
