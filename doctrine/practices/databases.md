...
A database schema should be setup for the first time by a regular database migration. The first database migration, therefore, will always setup the initial state of the schema.
