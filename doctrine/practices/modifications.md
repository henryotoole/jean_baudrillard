...
5. **Execution**: You kick off a separate, fresh-context sub-agent that executes the mod implementation in the project, runs tests, etc.
	1. Instruct the implementor-agent to **only** run tests relevant to the changes.
6. **Review**: You review the implementation:
	...
	4. Run the full test suite and ensure all are green.
