...
| Core Service | "service", "application service", "application container" | Any docker compose service that uses a Dockerfile to execute code that is unique to this project. |
