...
The doctrine has been edited to reflect both. `docex` has not. That gap is the campaign.
...
If you're going to drive a `docex` campaign from this, the doctrine reading order that gives you the cleanest mental model is:
