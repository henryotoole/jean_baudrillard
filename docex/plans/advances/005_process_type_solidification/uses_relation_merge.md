...
[`cicl.md § Uses Relationships`](../../../../doctrine/infrastructure/cicl.md#uses-relationships) — at the time of writing a subsection of its own, `Startup ordering is not a doctrine feature`, since folded into its parent:
...
[the gate cannot be honoured](../../../../doctrine/infrastructure/cicl.md#uses-relationships).
