...
2. **The three kinds *are* the three advance categories, at the engine level**
...
### 2.3 Tooling — docex subcommands (in scope for this advance)
...
16. **Tooling pulled into advance scope** (form + `scaffold`/`status`/`set`),
