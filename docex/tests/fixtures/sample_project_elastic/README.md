...
- `infra/contracts/api.openapi.yml` — **symlinked** to
  `../sample_project/infra/contracts/api.openapi.yml`. The Phase 3
...
ln -s ../../../sample_project/infra/contracts/api.openapi.yml infra/contracts/api.openapi.yml
```
