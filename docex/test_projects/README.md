...
The canonical architecture/design doc for these projects lives in the core planning tree at [`../plans/design/specifics/test_projects.md`](../plans/design/specifics/test_projects.md) — it covers why two foundations, the shared code identity, the nested-git-repo structure, the commit cadence between inner and outer repos, and the cut lifecycle.
