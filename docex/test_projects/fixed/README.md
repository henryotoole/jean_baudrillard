...
A minimal `fixed`-foundation smoke-test project. Run before cutting a `docex` minor or major version to surface release-path bugs that unit tests structurally can't reach.
