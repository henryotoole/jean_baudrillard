...
A processed ping older than the window is eligible for reaping. The
window is a positive whole number of days; zero or negative is invalid
(it would reap everything, including just-processed rows).
"""
...
class RetentionWindow:
    ...
    def cutoff(self, now: datetime) -> datetime:
        """The instant before which a processed ping is eligible to reap."""
