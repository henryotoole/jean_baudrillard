...
Verifies the alogic processes pings correctly against a stub repo. Real
postgres exercise happens implicitly through module integration during
the dev/test compose stack — see plans/core/worker/worker.md.
"""
