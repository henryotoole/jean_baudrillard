  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [{
          ...
          value = "service.namespace=docex_smoke_elastic,service.version=0.0.25,deployment.environment.name=prod,docex.codebase=api,docex.service=clock"
        }, {
  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [{
          ...
          name = "OTEL_RESOURCE_ATTRIBUTES"
          value = "service.namespace=docex_smoke_elastic,service.version=0.0.25,deployment.environment.name=prod,docex.codebase=api,docex.service=web"
        }, {
          name = "OTEL_SERVICE_NAME"
          value = "api-web"
        }, {
  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [{
          ...
          name = "OTEL_RESOURCE_ATTRIBUTES"
          value = "service.namespace=docex_smoke_elastic,service.version=0.0.25,deployment.environment.name=prod,docex.codebase=api,docex.service=worker"
        }, {
          name = "OTEL_SERVICE_NAME"
          value = "api-worker"
        }, {
  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [{
          ...
          name = "OTEL_RESOURCE_ATTRIBUTES"
          value = "service.namespace=docex_smoke_elastic,service.version=0.0.25,deployment.environment.name=prod,docex.codebase=api"
        }, {
          name = "OTEL_SERVICE_NAME"
          value = "api"
        }, {
