...
resource "aws_cloudwatch_log_group" "api-clock" {
  name              = "/docex_smoke_elastic/prod/api-clock"
  retention_in_days = 30
  tags = { managed_by = "doctrine", infra_tier = "environment", shape_name = "core_service", descriptor = "logs", project = "docex_smoke_elastic", env = "prod", codebase = "api", role = "clock", service = "clock", Name = "docex_smoke_elastic_prod_api_clock" }
}

resource "aws_ecs_task_definition" "api-clock" {
  family                   = "docex-smoke-elastic-prod-api-clock"
  requires_compatibilities = ["FARGATE"]
  network_mode             = "awsvpc"
  cpu                      = "512"
  memory                   = "1024"
  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [{
          ...
          value = "service.namespace=docex_smoke_elastic,service.version=0.0.21,deployment.environment.name=prod,docex.codebase=api,docex.service=clock"
        }, {
  ...
  tags = { managed_by = "doctrine", infra_tier = "environment", shape_name = "core_service", descriptor = "task-def", project = "docex_smoke_elastic", env = "prod", codebase = "api", role = "clock", service = "clock", Name = "docex_smoke_elastic_prod_api_clock" }
}

resource "aws_ecs_service" "api-clock" {
  name            = "docex-smoke-elastic-prod-api-clock"
  cluster         = data.terraform_remote_state.project.outputs.ecs_cluster_prod_arn
  ...
  service_connect_configuration {
    ...
    service {
      port_name      = "api-clock"
      discovery_name = "docex-smoke-elastic-prod-api-clock"
      client_alias {
        port     = 8082
        dns_name = "docex-smoke-elastic-prod-api-clock"
      }
    }
  }
  tags = { managed_by = "doctrine", infra_tier = "environment", shape_name = "core_service", descriptor = "ecs-svc", project = "docex_smoke_elastic", env = "prod", codebase = "api", role = "clock", service = "clock", Name = "docex_smoke_elastic_prod_api_clock" }
}
...
resource "aws_ecs_task_definition" "api-web" {
  family                   = "docex-smoke-elastic-prod-api-web"
  requires_compatibilities = ["FARGATE"]
  network_mode             = "awsvpc"
  cpu                      = "512"
  memory                   = "1024"
  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [{
          ...
          name = "OTEL_RESOURCE_ATTRIBUTES"
          value = "service.namespace=docex_smoke_elastic,service.version=0.0.21,deployment.environment.name=prod,docex.codebase=api,docex.service=web"
        }, {
          name = "OTEL_SERVICE_NAME"
          value = "api-web"
        }, {
          ...
          name = "WORKER_HOST"
          value = "docex-smoke-elastic-prod-api-worker"
        }, {
          name = "WORKER_PORT"
          value = "8081"
        }]
...
resource "aws_ecs_service" "api-web" {
  name            = "docex-smoke-elastic-prod-api-web"
  cluster         = data.terraform_remote_state.project.outputs.ecs_cluster_prod_arn
  ...
  service_connect_configuration {
    ...
    service {
      port_name      = "api-web"
      discovery_name = "docex-smoke-elastic-prod-api-web"
      client_alias {
        port     = 8080
        dns_name = "docex-smoke-elastic-prod-api-web"
      }
    }
  }
  load_balancer {
...
resource "aws_lb_target_group" "api-web" {
  name        = "docex-smoke-elastic-prod-09e172"
  port        = 8080
  protocol    = "HTTP"
  target_type = "ip"
  vpc_id      = data.terraform_remote_state.project.outputs.vpc_id
...
resource "aws_lb_listener_rule" "api-web" {
  ...
  condition {
    host_header {
      values = ["api-web.prod.docex-smoke-elastic.luxrnd.tech", "prod.docex-smoke-elastic.luxrnd.tech", "docex-smoke-elastic.luxrnd.tech"]
    }
  }
}
...
resource "aws_ecs_task_definition" "api-worker" {
  family                   = "docex-smoke-elastic-prod-api-worker"
  requires_compatibilities = ["FARGATE"]
  network_mode             = "awsvpc"
  cpu                      = "512"
  memory                   = "1024"
  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [{
          ...
          name = "OTEL_RESOURCE_ATTRIBUTES"
          value = "service.namespace=docex_smoke_elastic,service.version=0.0.21,deployment.environment.name=prod,docex.codebase=api,docex.service=worker"
        }, {
          name = "OTEL_SERVICE_NAME"
          value = "api-worker"
        }, {
...
resource "aws_ecs_service" "api-worker" {
  name            = "docex-smoke-elastic-prod-api-worker"
  cluster         = data.terraform_remote_state.project.outputs.ecs_cluster_prod_arn
  ...
  service_connect_configuration {
    ...
    service {
      ...
      discovery_name = "docex-smoke-elastic-prod-api-worker"
      client_alias {
        port     = 8081
        dns_name = "docex-smoke-elastic-prod-api-worker"
      }
    }
  }
...
resource "aws_ecs_task_definition" "api_migrate" {
  family                   = "docex-smoke-elastic-prod-api-migrate"
  requires_compatibilities = ["FARGATE"]
  network_mode             = "awsvpc"
  cpu                      = "512"
  memory                   = "1024"
  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [{
          ...
          name = "OTEL_RESOURCE_ATTRIBUTES"
          value = "service.namespace=docex_smoke_elastic,service.version=0.0.21,deployment.environment.name=prod,docex.codebase=api"
        }, {
          name = "OTEL_SERVICE_NAME"
          value = "api"
        }, {
