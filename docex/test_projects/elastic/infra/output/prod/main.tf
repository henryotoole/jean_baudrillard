  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [{
          ...
          value = "service.namespace=docex_smoke_elastic,service.version=0.0.14,deployment.environment.name=prod,docex.core_service=api,docex.process_type=web"
        }, {
  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [{
          ...
          name = "OTEL_RESOURCE_ATTRIBUTES"
          value = "service.namespace=docex_smoke_elastic,service.version=0.0.14,deployment.environment.name=prod,docex.core_service=api,docex.process_type=worker"
        }, {
          name = "OTEL_SERVICE_NAME"
          value = "api-worker"
        }, {
...
resource "aws_ecs_task_definition" "reaper-prune" {
  family                   = "docex-smoke-elastic-prod-reaper-prune"
  requires_compatibilities = ["FARGATE"]
  network_mode             = "awsvpc"
  cpu                      = "256"
  memory                   = "512"
  ...
  container_definitions = jsonencode([
    {
      environment = [{
          ...
          name = "OTEL_RESOURCE_ATTRIBUTES"
          value = "service.namespace=docex_smoke_elastic,service.version=0.0.14,deployment.environment.name=prod,docex.core_service=reaper,docex.process_type=prune"
        }, {
          name = "OTEL_SERVICE_NAME"
          value = "reaper-prune"
        }, {
...
resource "aws_iam_role" "reaper-prune_scheduler" {
  name = "docex_smoke_elastic_prod_reaper_prune_scheduler"
...
resource "aws_scheduler_schedule" "reaper-prune" {
  name = "docex-smoke-elastic-prod-reaper-prune"
  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [{
          ...
          name = "OTEL_RESOURCE_ATTRIBUTES"
          value = "service.namespace=docex_smoke_elastic,service.version=0.0.14,deployment.environment.name=prod,docex.core_service=api"
        }, {
          name = "OTEL_SERVICE_NAME"
          value = "api"
        }, {
